##########################################################################################################
## Coursera Getting & Cleaning Data Project Assignment
## Project submitted by Ashish Chandiok

# File: RunAnalysis.R
# Author: Ashish Chandiok
###############################################################################
...
#Initialization of the local directory on the computer to the 
#location where the UCI HAR Dataset is to be unzipped and created.
setwd('C:/Users/ASHISH/Desktop/Cognitive Research/Coursera/DataScienceSpecialization/Getting-and-Cleaning-Data-master/course-project/');

#downloading data from source provide
library(httr) 
...
# Creating datafolder and unzip files if not exist
